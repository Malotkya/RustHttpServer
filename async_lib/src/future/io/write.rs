...
impl<P: DerefMut + Unpin> AsyncWrite for Pin<P>
...
impl AsyncWrite for Vec<u8> {
    ...
    fn poll_write_vectored(self: Pin<&mut Self>, _cx: &mut Context<'_>, bufs: &[super::IoSlice<'_>]) -> Poll<io::Result<usize>> {
        Poll::Ready(io::Write::write_vectored(self.get_mut(), bufs))
    }
